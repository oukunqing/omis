...
namespace OMIS.Common
{
    ...
    public class Base64Coding
    {
        ...
        /// <returns></returns>
        public static string EncodingForString(string content, Encoding encoding)
        {
        ...
        public static string EncodingForString(string content)
        {
            return EncodingForString(content, Encoding.GetEncoding(65001));
        }

        /// <summary> 
        /// 从base64编码的字符串中还原字符串，支持中文 
        /// </summary> 
        /// <param name="code">base64加密后的字符串</param> 
        /// <param name="ens">System.Text.Encoding 对象，如创建中文编码集对象：System.Text.Encoding.GetEncoding(54936)</param> 
        /// <returns>还原后的文本字符串</returns> 
        public static string DecodingForString(string code, Encoding encoding)
        {
            /** 
            * *********************************************************** 
            * 
        ...
        /// <param name="code">base64加密后的字符串</param> 
        /// <returns>还原后的文本字符串</returns> 
        public static string DecodingForString(string code)
        {
            return DecodingForString(code, System.Text.Encoding.GetEncoding(65001));
        }
        ...
        public static string EncodingForFile(string fileName)
        {
            ...
            string code = Convert.ToBase64String(br.ReadBytes((int)fs.Length));
        ...
        /// </summary> 
        /// <param name="code">经base64加码后的字符串</param> 
        /// <param name="fileName">保存文件的路径和文件名</param> 
        /// <returns>保存文件是否成功</returns> 
        public static bool SaveDecodingToFile(string code, string fileName)
        {
            System.IO.FileStream fs = new System.IO.FileStream(fileName, System.IO.FileMode.Create);
            System.IO.BinaryWriter bw = new System.IO.BinaryWriter(fs);
            bw.Write(Convert.FromBase64String(code));
            bw.Close();
            fs.Close();
            return true;
        }
