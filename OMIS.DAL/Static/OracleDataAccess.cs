...
namespace OMIS.DAL
{
    ...
    public abstract class OracleDataAccess : OMIS.DBA.OracleDataAccess
    {
        ...
        {
            string sql = String.Format("select count(*) as exist from user_tables where table_name = '{0}';", tableName.ToUpper());
            return Convert.ToInt32(OracleHelper.ExecuteScalar(conn, sql).ToString()) > 0;
        }
        #endregion
    ...
    #region  OracleDBA
    public abstract class OracleDBA : OracleDataAccess
    {
    }
    #endregion
