...
namespace OMIS.DBA
{
    ...
    public abstract class DataCheck:  MyDateTime
    {
        ...
        {
            if ("select,insert,update,delete,create,alter".IndexOf(sql.ToLower().Trim().Split(' ')[0]) < 0)
            {
                sql = string.Empty;
            }
            return sql;
        ...
        public static string FilterStringList(string list)
        {
            return FilterStringList(list, ",", false);
        }

        public static string FilterStringList(string list, string delimiter)
        {
            return FilterStringList(list, delimiter, false);
        }

        public static string FilterStringList(string list, string delimiter, bool isValidate)
        {
            return FilterStringList(ref list, delimiter, isValidate);
        }
        #endregion
        ...
        {
            return FilterIdList(ref idList, ",", true, true);
        }

        public static string FilterIdList(ref string idList, string delimiter)
        {
            return FilterIdList(ref idList, delimiter, true, true);
        }

        public static string FilterIdList(ref string idList, string delimiter, bool isValidate, bool isIntNumber)
        {
            ...
            else if (isValidate || idList.EndsWith(delimiter) || idList.StartsWith(delimiter) || idList.IndexOf(String.Format("{0}{0}", delimiter)) >= 0)
            {
                ...
                {
                    if (isIntNumber ? IsIntNumber(id) : IsNumber(id))
                    {
                        tmp.Append(delimiter);
                        tmp.Append(id.Trim());
                    }
        ...
        public static string FilterIdList(string idList)
        {
            return FilterIdList(idList, ",", true);
        }

        public static string FilterIdList(string idList, string delimiter)
        {
            return FilterIdList(idList, delimiter, true);
        }

        public static string FilterIdList(string idList, string delimiter, bool isValidate)
        {
            return FilterIdList(ref idList, delimiter, isValidate, true);
        }
        #endregion

        #region  FilterNumberList
        public static string FilterNumberList(ref string idList)
        {
            return FilterIdList(ref idList, ",", true, false);
        }

        public static string FilterNumberList(ref string idList, string delimiter)
        {
            return FilterIdList(ref idList, delimiter, true, true);
        }

        public static string FilterNumberList(ref string idList, string delimiter, bool isValidate, bool isIntNumber)
        {
            return FilterIdList(ref idList, delimiter, isValidate, isIntNumber);
        }

        public static string FilterNumberList(string idList)
        {
            return FilterIdList(idList, ",", true);
        }

        public static string FilterNumberList(string idList, string delimiter)
        {
            return FilterIdList(idList, delimiter, true);
        }

        public static string FilterNumberList(string idList, string delimiter, bool isValidate)
        {
            return FilterIdList(ref idList, delimiter, isValidate, true);
        }
        #endregion
