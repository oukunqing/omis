...
var arrMenu = [
    { id: 'Root', name: '系统设置菜单' },
    { pid: 'Root', id: 'SystemMenu', name: '系统设置' },
    //{ pid: 'SystemMenu', name: '系统设置', url: strMenuPath + '/config.aspx', open: 1 },
    { pid: 'SystemMenu', name: '系统设置', url: strMenuPath + '/config.aspx' },
    { pid: 'SystemMenu', name: '标签页设置', url: strMenuPath + '/tab.aspx' },
    { pid: 'SystemMenu', name: '页面表单设置', url: strMenuPath + '/page.aspx' },
    { pid: 'SystemMenu', name: '服务器设置', url: strMenuPath + '/server.aspx' },

    { pid: 'Root', id: 'UserMenu', name: '用户设置' },
    { pid: 'UserMenu', name: '用户帐户设置', url: strMenuPath + '/user.aspx' },
    { pid: 'UserMenu', name: '高级权限设置', url: strMenuPath + '/role.aspx' },

    { pid: 'Root', id: 'PictureMenu', name: '图片设置' },
    { pid: 'PictureMenu', name: 'LOGO图片', url: strMenuPath + '/logo.aspx' },
    { pid: 'PictureMenu', name: '登录界面图片', url: strMenuPath + '/loginBg.aspx' },
    { pid: 'PictureMenu', name: '顶部背景图片', url: strMenuPath + '/banner.aspx' },
    { pid: 'PictureMenu', name: '首页欢迎图片', url: strMenuPath + '/welcome.aspx' },
    { pid: 'PictureMenu', name: 'ICON图标设置', url: strMenuPath + '/icon.aspx' },

    { pid: 'Root', id: 'MapMenu', name: '地图设置' },
    { pid: 'MapMenu', name: '地图类型及密钥', url: strMenuPath + '/mapKey.aspx' },
    { pid: 'MapMenu', name: '地图设置', url: strMenuPath + '/map.aspx' },

    { pid: 'Root', id: 'SmsMenu', name: '电话短信设置' },
    { pid: 'SmsMenu', name: '电话短信号码设置', url: strMenuPath + '/phone.aspx' }
];
