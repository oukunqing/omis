<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="sensorChannelModeList.aspx.cs" Inherits="modules_sensor_config_sensorChannelModeList" %>
...
<%=Public.LoadJsCode("sensorChannelModeList.js?{0}")%></asp:Content>