<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="sensorOriginalTypeList.aspx.cs" Inherits="modules_sensor_config_sensorOriginalTypeList" %>
...
<%=Public.LoadJsCode("sensorOriginalTypeList.js?{0}")%></asp:Content>