<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="moduleList.aspx.cs" Inherits="modules_systems_module_moduleList" %>
...
<%=Public.LoadJsCode("moduleList.js?{0}")%></asp:Content>