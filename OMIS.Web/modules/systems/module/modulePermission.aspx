<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="modulePermission.aspx.cs" Inherits="modules_systems_module_modulePermission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <div id="bodyTitle"> - <label id="lblModuleName"></label></div>
    <div id="bodyContent">
        <div id="formBody">
...
<%=Public.LoadJsCode("modulePermission.js?{0}")%></asp:Content>