<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="permissionList.aspx.cs" Inherits="modules_systems_permission_permissionList" %>
...
<%=Public.LoadJsCode("permissionList.js?{0}")%></asp:Content>