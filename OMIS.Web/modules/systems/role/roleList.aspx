<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="roleList.aspx.cs" Inherits="modules_systems_role_roleList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <div id="bodyContent">
        ...
        <div id="bodyForm" class="operform">
            ...
            <select id="ddlGroup" class="select" title="用户组别"></select>
        </div>
        </form>
    </div>
...
<%=Public.LoadJsCode("roleList.js?{0}")%></asp:Content>