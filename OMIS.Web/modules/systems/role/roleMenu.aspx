<%@ Page Title="" Language="C#" MasterPageFile="~/masters/mpPage.master" AutoEventWireup="true" CodeFile="roleMenu.aspx.cs" Inherits="modules_systems_role_roleMenu" %>
...
<%=Public.LoadJsCode("roleMenu.js?{0}")%></asp:Content>