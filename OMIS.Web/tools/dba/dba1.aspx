<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dba1.aspx.cs" Inherits="tools_dba1" ValidateRequest="false" %><!DOCTYPE html>
<html>
<head>
        ...
        <table cellpadding="0" cellspacing="0" class="tbdata">
            <tr>
                <td style="width:450px;padding-top:5px;">
                    ...
                    <i>Class Info</i>:
                    <br />
                    <asp:TextBox ID="txtClassData" CssClass="txt flag1" runat="server" Width="498px" Height="200px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                ...
                <td style="padding-left:10px;">
                    <table cellpadding="0" cellspacing="0" class="tbdata">
                        ...
                        <tr>
                            <td>
                                <div class="div-txt"><i>Model</i>:</div>
                                <asp:TextBox ID="txtModel" CssClass="txt" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                                <div class="div-txt"><i>Constructor Function</i>:</div>
                                <asp:TextBox ID="txtConstructor" CssClass="txt" runat="server" Width="400px" Height="60px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                ...
                                Convert Func:<asp:TextBox ID="txtConvertFunc" runat="server" Width="180px">DataConvert.ConvertValue</asp:TextBox>
                                </div>
                                <asp:TextBox ID="txtFillData" CssClass="txt flag1" runat="server" Width="400px" Height="132px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtDBConnString" runat="server">DBConnectionString</asp:TextBox>                            
                            </td>                            
                            <td style="padding-left:10px;">
                                <asp:TextBox ID="txtDBConnString1" runat="server">DBConnString</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Get Single Info</i>:<br />
                                <asp:TextBox ID="txtGetInfo1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Get Multi Info</i>:<br />
                                <asp:TextBox ID="txtGetInfo2" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Get Info</i>:<br />
                                <asp:TextBox ID="txtGetInfo3" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Get Info(BLL)</i>:<br />
                                <asp:TextBox ID="txtGetInfo33" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Add Method</i>:<br />
                                <asp:TextBox ID="txtAddMethod" CssClass="txt flag" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Add Method-1</i>:<br />
                                <asp:TextBox ID="txtAddMethod1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Update Method</i>:<br />
                                <asp:TextBox ID="txtUpdateMethod" CssClass="txt flag" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Update Method-1</i>:<br />
                                <asp:TextBox ID="txtUpdateMethod1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td><i>Delete Method</i>:<br />
                                <asp:TextBox ID="txtDelMethod" CssClass="txt flag" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;"><i>Delete Method-1</i>:<br />
                                <asp:TextBox ID="txtDelMethod1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td><i>Add Sql</i>:<br />
                                <asp:TextBox ID="txtAddSql" CssClass="txt" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;"><i>Update Sql</i>:<br />
                                <asp:TextBox ID="txtUpdateSql" CssClass="txt" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Add Sql Param</i>:<br />
                                <asp:TextBox ID="txtAddSqlParam" CssClass="txt flag" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Add Sql Param-1</i>:<br />
                                <asp:TextBox ID="txtAddSqlParam1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Update Sql Param</i>:<br />
                                <asp:TextBox ID="txtUpdateSqlParam" CssClass="txt flag" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Update Sql Param-1</i>:<br />
                                <asp:TextBox ID="txtUpdateSqlParam1" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <i>Get Single Info(BLL)</i>:<br />
                                <asp:TextBox ID="txtGetInfo11" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                            <td style="padding-left:10px;">
                                <i>Get Multi Info(BLL)</i>:<br />
                                <asp:TextBox ID="txtGetInfo22" CssClass="txt flag1" runat="server" Width="400px" Height="70px" TextMode="MultiLine" spellcheck="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
